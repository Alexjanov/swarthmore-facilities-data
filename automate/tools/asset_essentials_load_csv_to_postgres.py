...
#
# Asset Essentials-specific settings:
# COLS_KEEP="column1,column2,column3"
# COL_TYPES="TEXT,INTEGER,DATE"
# PGTARGET_SCHEMA="raw"
# PGTARGET_TABLE="facilities"
# PGUPSERT_KEY="unique_id_column"
#
# To run: python asset_essentials_load_csv_to_postgres.py --csv /path/to/your/asset_essentials_data.csv
