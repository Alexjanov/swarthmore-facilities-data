with raw_source as (
   ...
   , final as (select
    ...
    "DateOriginated"::             timestamp as date_originated ,
    "DateExpected"::               timestamp as date_expected ,
    "DateAssigned"::               timestamp as date_assigned ,
    "DateCompleted"::              timestamp as date_completed ,
    "DateUpdated"::                timestamp as date_updated ,
    ...
    "WorkOrderTriggerDate"::       timestamp as work_order_trigger_date ,
